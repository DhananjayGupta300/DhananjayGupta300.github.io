...
effectively describes the feeling when a programming project reaches it's succefull climax. For many, the joys far outweigh the woes, and for them, this shall be the right guide to reach their own [*prograsm*](http://dgupta.us/Prograsm/).
...
I would highly recomend reading the book for your enlightenment on software development.
