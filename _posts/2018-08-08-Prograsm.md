...
+ The success of scaling-up project depends upon the fact that the conceptual integrity of each piece has been raically improved—that the number of minds determining the design has been divided by seven. So is possible to put 200 people and face the problem of coordinating only 20 minds., those of the surgeons. <br/><br/>
